export default {
  leaderboard: {
    ...
    page_subtitle: "Sube a la cima y conviértete en una leyenda de LiftTime",
  ...
  premium: {
    ...
    already_premium: "Estás disfrutando de LiftTime Premium",
    no_ads: "Sin anuncios",
    upgrade: "Actualizar",
    ...
    faq: {
      ...
      subtitle: "Todo lo que necesitas saber sobre LiftTime y nuestra misión",
      items: [
        {
        ...
        {
          question: "¿Puedo auto-alojar LiftTime?",
          answer:
    ...
    free_intro_text:
      "LiftTime es una aplicación de fitness gratuita y de código abierto utilizada diariamente por más de 60,000 usuarios. Está construida con amor (no con dinero de VC ^^) y nos cuesta tiempo y dinero real mantenerla funcionando.",
    donation_story_text:
      "Al principio, funcionábamos con donaciones. Pero como puedes imaginar, las donaciones no fueron suficientes para cubrir los costos de desarrollo y funcionamiento. Así que creamos un paquete que nos ayudará a mantener las luces encendidas y desbloquear algunos superpoderes en el camino.",
    health_upgrade_text: "Si LiftTime te ayuda a mejorar tu salud, por favor considera pasarte a Premium :D !",
    ...
    still_unsure: "¿Todavía no estás seguro? No te preocupes. LiftTime siempre seguirá siendo gratuito y de código abierto.",
  ...
  release_notes: {
    ...
    notes: {
      ...
      note_2026_03_08: {
        ...
        content:
          "<li>Los enlaces sociales del footer ahora se ocultan durante sesiones de entrenamiento activas para reducir distracciones</li><li>El layout móvil ahora usa mejor altura completa, con espaciado inferior seguro en iOS para acceder mejor a la barra de navegación</li><li>Al añadir un ejercicio a mitad de sesión, ahora se piden recomendaciones y se precargan series sugeridas cuando existe historial</li><li>El orden por defecto en series con peso queda estabilizado como <strong>Peso y luego Repeticiones</strong>, con lbs por defecto para evitar intercambios de columnas</li><li>Se actualizaron favicon e iconos de app para que coincidan con el logo actual de LiftTime</li><li>Se eliminó por ahora el popup de donación/premium tras terminar una sesión (el soporte quedó preparado en código para reactivarlo luego)</li>",
      },
      note_2026_03_05: {
      ...
      note_2026_02_20: {
        ...
        content:
          "<li>La nueva barra fija de progreso muestra el avance de la sesión y cambia a un temporizador de descanso tras cada serie</li><li>Ahora puedes ver de un vistazo el estado de series y ejercicios, incluyendo progreso compacto como Series x/y</li><li>Las tarjetas de ejercicio ahora son colapsables para reducir el desplazamiento en sesiones largas</li><li>Ahora puedes reordenar ejercicios dentro de una sesión activa con controles de subir/bajar</li><li>Los ejercicios con barra ahora muestran una guía clara bajo el peso: <strong>Barra + Discos</strong></li><li>Las preferencias de privacidad ya no reaparecen en cada recarga en entornos locales/autohospedados</li><li>Actualización de marca: nuevo logo y firma de Portland en login, registro y estadísticas</li><li>El texto del reinicio de clasificación ahora se muestra claramente como <strong>PST (Portland)</strong></li><li>La lógica de progresión ya está preparada por modo (Principiante/Avanzado), y omitir datos de esfuerzo no penaliza recomendaciones</li>",
      },
      note_2026_02_19: {
        title: "💪 Flujo de entrenamiento más inteligente + seguimiento de progreso",
        content:
          "<li>Las series auto-rellenadas ahora usan tu rendimiento reciente, objetivo de entrenamiento y carga muscular</li><li>El creador de entrenamientos ahora soporta 3 estilos: Equipo + Músculos, Solo Equipo, o Elegir Individualmente</li><li>Los objetivos (Fuerza, Hipertrofia, Resistencia) ahora ajustan repeticiones, estilo de series y descanso por defecto</li><li>Las recomendaciones ahora incluyen series de calentamiento antes de las series de trabajo</li><li>Nuevo panel de Progreso Muscular con estado objetivo (por debajo, en objetivo, fatiga alta)</li><li>Estadísticas con nuevas ventanas cortas (1 semana y 2 semanas) para feedback más rápido</li>",
      },
      note_2025_10_29: {
      ...
      note_2025_06_19: {
        ...
        content:
          "¡LiftTime v1.2 ahora es una Progressive Web App! Instálala en tu teléfono para una experiencia de aplicación nativa con acceso sin conexión. 🚀",
      },
      note_2025_06_18: {
        title:
        ...
        content:
          "¡LiftTime alcanzó el primer lugar en Hacker News! ¡Gracias a todos por el increíble apoyo y bienvenidos a todos los nuevos usuarios! 💪",
      },
      note_2025_06_01: {
  ...
  donation_alert: {
    title: "Desbloquea funciones avanzadas con LiftTime Premium",
    or: "o",
  },
