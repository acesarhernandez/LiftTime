export default {
  leaderboard: {
    ...
    reset_timezone: "Reinicialização PST (Portland)",
    reset_timezone_description: "As classificações semanais e mensais reiniciam à meia-noite em PST (Portland)",
  },
  programs: {
  ...
  premium: {
    ...
    faq: {
      ...
      additional_support: {
        ...
        community: "Suporte comunitário (discord ou cesarhernandezl@proton.me)",
  ...
  release_notes: {
    ...
    notes: {
      note_2026_03_24: {
        title: "🔐 v1.5.0: Auth com Keyholder + experiência de acesso mais limpa",
        content:
          "<li>Integração de login com Keyholder (Authentik) junto com a autenticação existente por email/palavra-passe</li><li>O fluxo sem sessão agora é auth-first: uma página de login dedicada no lugar de uma experiência parcial dentro da app</li><li>Melhorias de UX no login: texto mais claro, hierarquia visual melhor e interações refinadas na página de autenticação</li><li>Os links de Twitter foram removidos e os atalhos/ícones de email agora apontam para cesarhernandezl@proton.me</li><li>Os links de conteúdo de Doar, Sobre e Privacidade estão temporariamente ocultos enquanto o novo conteúdo é preparado, mantendo a infraestrutura para reativação futura</li>",
      },
      note_2026_03_08: {
        title: "📱 Polimento de UX mobile + melhorias de fiabilidade na sessão",
        content:
          "<li>Os links sociais do footer agora ficam ocultos durante sessões de treino ativas para reduzir distrações</li><li>O layout mobile agora aproveita melhor a altura total, com melhor espaçamento inferior no iOS para acesso à barra de navegação</li><li>Ao adicionar um exercício no meio da sessão, a app agora busca recomendações e pré-preenche séries sugeridas quando existe histórico</li><li>A ordem padrão de colunas em séries com carga foi estabilizada para <strong>Peso e depois Repetições</strong>, com lbs pré-definido para evitar trocas de coluna</li><li>Favicon e ícones da app foram atualizados para combinar com o logo atual do LiftTime</li><li>O popup de doação/premium após o treino foi removido por agora (a base ficou pronta no código para reativação futura)</li>",
      },
      note_2026_03_05: {
        title: "🏋️ Fluxo de sessão melhorado + recomendações de carga mais precisas",
        content:
          "<li>Agora é possível adicionar exercícios diretamente durante uma sessão ativa</li><li>Ao concluir todas as séries, o app não avança imediatamente: o cartão mantém as duas ações <strong>Adicionar série</strong> e <strong>Próximo exercício</strong></li><li>Ao avançar, o exercício finalizado é marcado como concluído, recolhido e movido para o topo na ordem em que foi concluído</li><li>Os exercícios ativos ficam após os exercícios concluídos para uma fila de sessão mais limpa</li><li>A reordenação de exercícios em sessão ativa agora usa arrastar e soltar</li><li>O campo de peso agora aceita decimais e limpar o campo não força mais um 0 persistente</li><li>A base de recomendação agora acompanha melhor cargas recentes mais pesadas, reduzindo sugestões muito abaixo do esperado</li>",
      },
      note_2026_02_20: {
        title: "📊 Registro preciso + controles inteligentes de sessão",
        content:
          "<li>A nova barra fixa de progresso acompanha a sessão e muda para o temporizador de descanso após cada série</li><li>Os estados de séries e exercícios agora ficam visíveis de imediato, incluindo progresso compacto como Séries x/y</li><li>Os cartões de exercício agora são recolhíveis para reduzir rolagem em sessões longas</li><li>Agora você pode reordenar exercícios dentro de uma sessão ativa com controles de subir/descer</li><li>Os exercícios com barra agora mostram um aviso claro abaixo do peso: <strong>Barra + Anilhas</strong></li><li>As preferências de privacidade não reaparecem mais a cada recarga em ambiente local/self-host</li><li>Atualização de branding: novo logo e assinatura de Portland em login, cadastro e estatísticas</li><li>A mensagem de reset do ranking agora mostra claramente <strong>PST (Portland)</strong></li><li>A lógica de progressão já está pronta para modos (Iniciante/Avançado), e pular dados de esforço não penaliza recomendações</li>",
      },
      note_2026_02_19: {
      ...
      note_2025_06_23: {
        ...
        content:
          "A app agora suporta <strong>português</strong>! Também adicionámos um <em>banner de doação</em> para ajudar a suportar os custos do projeto. 🙏",
      },
      note_2025_06_22: {
