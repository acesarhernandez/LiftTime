export default {
  leaderboard: {
    ...
    page_subtitle: "Grimpez au sommet et devenez une légende LiftTime",
  ...
  premium: {
    ...
    already_premium: "Vous profitez de LiftTime Premium",
    ...
    faq: {
      ...
      subtitle: "Tout ce que vous devez savoir sur LiftTime et notre mission",
      items: [
        {
        ...
        {
          question: "Puis-je auto-héberger LiftTime ?",
          answer:
      ...
      additional_support: {
        ...
        community: "Support communautaire (discord ou cesarhernandezl@proton.me)",
    ...
    free_intro_text:
      "LiftTime est une application de fitness gratuite et open-source utilisée quotidiennement par plus de 60 000 utilisateurs. Elle est construite avec amour (pas avec l'argent des VCs ^^) et nous coûte du temps et de l'argent réels pour la maintenir en ligne.",
    donation_story_text:
    ...
    health_upgrade_text: "Si LiftTime vous aide à améliorer votre santé, pensez à passer Premium :D !",
    ...
    still_unsure: "Toujours pas sûr ? Pas de souci. LiftTime restera toujours gratuit et open-source.",
  ...
  release_notes: {
    ...
    notes: {
      note_2026_03_24: {
        title: "🔐 v1.5.0 : Auth Keyholder + expérience de connexion recentrée",
        content:
          "<li>Intégration de la connexion Keyholder (Authentik) en plus de l'authentification email/mot de passe</li><li>Le parcours non connecté devient désormais auth-first : une vraie page de connexion dédiée remplace l'ancienne expérience partielle dans l'app</li><li>Polish UX du login : texte clarifié, meilleure hiérarchie visuelle et interactions de page auth améliorées</li><li>Les liens Twitter ont été retirés, et les raccourcis/icônes email pointent maintenant vers cesarhernandezl@proton.me</li><li>Les liens de contenu Donation, À propos et Confidentialité sont temporairement masqués pendant la préparation du nouveau contenu, tout en conservant l'infrastructure pour réactivation plus tard</li>",
      },
      note_2026_03_08: {
      ...
      note_2026_02_20: {
        ...
        content:
          "<li>La nouvelle barre de progression fixe suit la séance et bascule sur un minuteur de repos après chaque série</li><li>Les statuts des séries et des exercices sont visibles d'un coup d'œil, avec un format compact comme Séries x/y</li><li>Les cartes d'exercices sont maintenant repliables pour limiter le scroll pendant les longues séances</li><li>Vous pouvez désormais réordonner les exercices dans une séance active avec des boutons monter/descendre</li><li>Les mouvements à la barre affichent désormais une indication claire sous le poids : <strong>Barre + Disques</strong></li><li>Les préférences de confidentialité ne réapparaissent plus à chaque rechargement en local/self-host</li><li>Mise à jour branding : nouveau logo et signature Portland sur connexion, inscription et statistiques</li><li>Le libellé de reset du classement indique maintenant clairement <strong>PST (Portland)</strong></li><li>La logique de progression est désormais prête pour les modes (Débutant/Avancé), et ignorer la donnée d'effort ne pénalise pas les recommandations</li>",
      },
      note_2026_02_19: {
      ...
      note_2025_06_23: {
        ...
        content:
          "L'app supporte maintenant le <strong>portugais</strong> ! Nous avons aussi ajouté une <em>bannière de don</em> pour aider à supporter les coûts du projet.",
      },
      note_2025_06_22: {
      ...
      note_2025_06_19: {
        ...
        content:
          "LiftTime v1.2 est maintenant une Progressive Web App ! Installez-la sur votre téléphone pour une expérience d'application native avec accès hors ligne.",
      },
      note_2025_06_18: {
        title:
        ...
        content:
          "LiftTime a atteint le <strong>top spot</strong> sur Hacker News ! Merci à tous pour le support incroyable — bienvenue à tous les nouveaux utilisateurs ! 💪",
      },
      note_2025_06_01: {
  ...
  donation_alert: {
    title: "Débloquez des fonctionnalités avancées avec LiftTime Premium",
    or: "ou",
  },
